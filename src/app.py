...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn and play recreational and competitive tennis",
    ...
    "Debate Team": {
        "description": "Compete in public speaking and formal debate competitions",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    if email not in activity["participants"]:
        raise HTTPException(
            status_code=404, detail="Student not registered for this activity")
